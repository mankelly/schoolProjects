...
Trap::Trap(int x, int y, int xLimit, int yLimit, std::string spriteFile, EntityType type, int penaltyLevel, string phrase) : Entity(x, y, xLimit, yLimit, spriteFile, type) {
